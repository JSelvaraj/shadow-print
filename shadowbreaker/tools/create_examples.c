/**
 * @file create_examples.c
 *
 * @brief DO NOT EDIT THIS FILE
 *
 * For shadowbreaker purposes, use count of 1 at command line.
 * (This program can be used to generate many passwords, however.)
 */
...
#define PASSWORD_LEN 8 // change this to test your passwords w/ diff lengths

void printHelp() {
  printf("\n"
         "  create_examples [-soln] <count> <min-iter> <max-iter>\n"
         "\n"
         "    Print <count> sample inputs for shadow_breaker.\n"
         "    Each will take between <min-iter> and <max_iter> iterations\n"
...
// create a password that will take iter_count iterations to recover
...
int main(int argc, char **argv) {
  ...
  for (i = 0; i < count; i++) {
    ...
    snprintf(username, USERNAME_LEN, "u%07d", i);
    ...
    char *hash = crypt(password, "cs2002");
